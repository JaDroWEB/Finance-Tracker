...
export class IncomeTableComponent {
    ...
    public readonly incomes$: Observable<(Transaction & { category: string })[]>;
    ...
    constructor(
        ...
        this.incomes$ = combineLatest([
            this.financeFacade.financeTransactions.incomeTransactions$,
            this.financeFacade.financeCategories.incomeCategories$
        ]).pipe(
    ...
    public addTransaction(): void {
        this.dialogService.open(TransactionModalComponent, { context: { type: CategoryType.INCOME } });
    }

    public addCategory(): void {
        this.dialogService.open(AddCategoryModalComponent, { context: { type: CategoryType.INCOME } });
    }
}
